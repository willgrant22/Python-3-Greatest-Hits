...
class MyWindow(Gtk.Window):
    ...
    def init_ui(self):    
        ...
        self.bardejov = GdkPixbuf.Pixbuf.new_from_file("anap_logo.png")
        self.rotunda = GdkPixbuf.Pixbuf.new_from_file("anap_logo.png")
        self.mincol = GdkPixbuf.Pixbuf.new_from_file("anap_logo.png")
